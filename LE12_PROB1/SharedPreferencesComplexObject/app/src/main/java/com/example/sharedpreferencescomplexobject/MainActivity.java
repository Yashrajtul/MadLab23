package com.example.sharedpreferencescomplexobject;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("com.example.sharedpreferencescomplexobject", Context.MODE_PRIVATE);
